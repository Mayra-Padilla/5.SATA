 ...
 * @author Mayra
 */
public class Canalizaciones extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("CANALIZACIONES");
        ...
        Horarios.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Departamento", "Fecha de creació", "Fecha de finalización", "Estado"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Canalizaciones.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Canalizaciones().setVisible(true);
            }
        });
    }
